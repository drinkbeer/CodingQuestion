...
//     }
    ...
    */
    ...
    /*
    Time O(NlogN)
    Runtime: 810 ms, faster than 5.02% of Java online submissions for K Closest Points to Origin.
    Memory Usage: 118.6 MB, less than 12.60% of Java online submissions for K Closest Points to Origin.
    */
//     public int[][] kClosest(int[][] points, int K) {
...
//     }
    ...
    Runtime: 527 ms, faster than 5.02% of Java online submissions for K Closest Points to Origin.
    Memory Usage: 118.2 MB, less than 17.29% of Java online submissions for K Closest Points to Origin.
    */
    public int[][] kClosest(int[][] points, int K) {
