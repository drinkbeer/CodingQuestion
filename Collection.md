...
The height/depth of a tree: The height of a node is the length of the longest downward path to a leaf from that node. The height of the root is the height of the tree. 
...
根的深度为0，叶子高度为0.只有一个节点的树的depth height 都为0. 按照惯例，一个空树的depth, height 都是-1

REF:
[1] http://xlinux.nist.gov/dads//HTML/perfectBinaryTree.html 
[2] http://courses.cs.vt.edu/~cs3114/Fall09/wmcquain/Notes/T03a.BinaryTreeTheorems. [3] http://courses.csail.mit.edu/6.006/fall09/lecture_notes/lecture04.pdf 
